...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0, score1, last_score_1=last_score, running_high_1=running_high):
        if who == 0:
            sub = score0 - last_score_1
            last_score_1 = score0
        else:
            sub = score1 - last_score_1
            last_score_1 = score1
        if sub > running_high_1:
            print(sub, "point(s)! The most yet for Player", who)
            running_high_1 = sub
        return announce_highest(who, last_score_1, running_high_1)
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    """ 
    for Suite2 -> case2
    when the result of roll_dice(2, dice) equals to (3, 1)
    the score will return to 1 instead of 4
    so it will be (1 + 11) / 2 == 6.0
    not (4 + 11) / 2 == 7.5
    Attention !!!!!!!!!!!!!!!!!!!
    """
    # BEGIN PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    trun, current, max_num, min_roll = 0, 0, -1, 0
    while trun < 10:
        trun += 1
        current = averaged_roll(trun, dice)
        if current > max_num:
            max_num = current
            min_roll = trun
    return min_roll
